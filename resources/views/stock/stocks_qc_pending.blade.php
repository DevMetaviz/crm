...
@section('title', 'Stock QC Pending')
@section('header-css')
...
@section('content-header')
    <!-- Content Header (Page header) -->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Stock QC Pending</h1>
                ...
                <table id="example1" class="table table-bordered table-hover mt-4" style="">
                 ...
                 <tr>
                    ...
                    <td>{{$stocks[$i]['item_name']}}</td>
                     ...
                     <th><a href="{{url('/qa-sampling/'.$stocks[$i]['stock_id'])}}" title="Gerante Sampling"><span class="fas fa-cog"></span></a></th>
                    </tr>

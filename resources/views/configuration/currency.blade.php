...
<form role="form" method="post" action="{{url('configuration/currency/save')}}">
      ...
      <button type="button" class="close" data-dismiss="alert">&times;</button>
        {{ session()->get('error') }}
             ...
             @endif
                   ...
                   <legend class="w-auto">Add New Currency</legend>
                   <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                  ...
                  <input type="text"  name="symbol" class="form-control  col-sm-8" value=""  required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="col-sm-12">
                  ...
                  <label class="col-sm-8 offset-sm-4"><input type="checkbox" name="is_default" value="1" id="is_default" class="" >&nbsp&nbspDefault</label>
                  </div>
                </div>

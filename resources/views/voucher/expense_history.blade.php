...
@section('content-header')
    <!-- Content Header (Page header) -->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Expense List</h1>
            <a class="btn" href="{{url('expense/create')}}" style="border: none;background-color: transparent;"><span class="fas fa-edit">&nbsp</span>New</a>
          </div>
          <div class="col-sm-6">
                  ...
                  <tbody>
                   ...
                   <?php $i=1;  ?>
                    @foreach($vouchers as $order)
                     ...
                     <td><a href="{{url('edit/expense/'.$order['id'])}}">{{$order['voucher_no']}}</a></td>
                    ...
                    <td>{{$let['pivot']['cheque_no']}}</td>
                     ...
                     <td><a href="{{url('edit/expense/'.$order['id'])}}"><span class="fa fa-edit"></span></a></td>

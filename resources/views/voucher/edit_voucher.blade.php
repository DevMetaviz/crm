...
<form role="form" id="purchase_demand" method="POST" action="{{url('/voucher/update')}}">
      ...
      <div id="std_error" style="display: none;"><p class="text-danger" id="std_error_txt"></p></div>
            ...
            <div class="row">
              <div class="col-md-3">
                   ...
                   <h4 class="form-section-title"><i class="fas fa-file-alt mr-2"></i><span id="voucher_type_head">{{$voucher['voucher_type']['name']}}</span></h4>
                ...
                <div class="form-group">
                  ...
                  <input type="text" form="purchase_demand" name="voucher_no" id="voucher_no" class="form-control select2" value="{{$voucher['voucher_no']}}" readonly required style="width: 100%;">
                  </div>


                <div class="form-group">
                  <label>Voucher Date</label>
                  <input type="date" form="purchase_demand" name="voucher_date" id="voucher_date" class="form-control select2" value="{{$voucher['voucher_date']}}" required style="width: 100%;">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <select form="purchase_demand" name="status" class="form-control" required >
                        <option value="1" @if($voucher['status']==1){{'selected'}}@endif >Post</option>
                        <option value="0" @if($voucher['status']==0){{'selected'}}@endif >Unpost</option>
                    </select>
                  </div>
    ...
    <div class="tab-pane fade show active" id="tabA">
      ...
      <table class="table table-bordered table-hover"  id="item_table" >
        ...
        <tbody id="selectedItems">
           ...
           <input type="hidden" form="purchase_demand" id="{{'pivot_id_'.$row}}" name="pivots_id[]" value="{{$acc['pivot']['id']}}"  >
           <input type="hidden" form="purchase_demand" id="{{'account_id_'.$row}}" name="accounts_id[]" value="{{$acc['id']}}" readonly >

           <input type="hidden" form="purchase_demand" id="{{'sub_sub_account_id_'.$row}}" name="sub_accounts_id[]" value="{{$acc['super_account']['id']}}" readonly >
     
     <td id="{{'sub_sub_account_text_'.$row}}">{{$acc['super_account']['name']}}</td>
...
<td><input type="text" class="form-control" value="{{$acc['pivot']['cheque_date']}}" form="purchase_demand" name="cheque_date[]" id="{{'cheque_date_'.$row}}" readonly ></td>
     ...
     <td><input type="text" class="form-control" value="{{$acc['pivot']['debit']}}" form="purchase_demand" name="debit[]" id="{{'debit_'.$row}}" readonly ></td>
      <td><input type="text" class="form-control" value="{{$acc['pivot']['credit']}}" form="purchase_demand" name="credit[]" id="{{'credit_'.$row}}" readonly ></td>
...
<!-- End Tabs -->
    ...
    <form role="form" id="#add_item">
            ...
            <form role="form" id="delete_form" method="POST" action="{{url('/delete/voucher/'.$voucher['id'])}}">
     @csrf    
    </form>

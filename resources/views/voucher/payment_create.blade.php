...
<!-- /print modal -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-gradient-info">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a class="btn btn-outline-light" id="print_btn"  href="{{url('/voucher/report2/'.session()->get('payment_id') )}}" target="_blank" >Yes</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
      ...
      <!-- /.print modal -->
       ...
       <form role="form" id="purchase_demand" method="POST" action="{{url('/payment/save')}}">

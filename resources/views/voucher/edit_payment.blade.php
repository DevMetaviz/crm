    ...
    <!-- Content Header (Page header) -->
      ...
      <div class="row default-header"  >
          ...
          <div class="col-sm-6 text-right">
            ...
            <a class="btn btn-transparent" href="{{url('payment/create')}}" ><span class="fas fa-plus">&nbsp</span>New</a>
            <a class="btn btn-transparent" href="{{url('payment/history')}}" ><span class="fas fa-history">&nbsp</span>Payment List</a>
...
@section('content')
    ...
    <form role="form" id="purchase_demand" method="POST" action="{{url('/payment/update')}}">
            ...
            <div class="row">
              <div class="col-md-9">
                  ...
                  <div class="form-section">
                   <h4 class="form-section-title"><i class="fas fa-file-alt mr-2"></i>Payment Voucher</h4>
                ...
                <div class="col-md-3 form-group ">
                  ...
                  <input type="text" form="purchase_demand" name="voucher_no" id="voucher_no" class="form-control select2" value="{{$payment['voucher_no']}}" readonly required style="width: 100%;">
                  </div>


                <div class="col-md-3 form-group">
                  <label>Voucher Date</label>
                  <input type="date" form="purchase_demand" name="voucher_date" id="voucher_date" onchange="setDocNo()" class="form-control select2" value="{{$payment['voucher_date']}}" required style="width: 100%;">
                  </div>
              ...
              <div class="col-md-9">
                 ...
                 <div class="form-section">
                   <h4 class="form-section-title"><i class="fas fa-plus-circle mr-2"></i>Payment Detail</h4>
...
<!-- End Tabs -->
   ...
   <form role="form" id="delete_form" method="POST" action="{{url('/delete/payment/'.$payment['id'])}}">
     @csrf    
    </form>

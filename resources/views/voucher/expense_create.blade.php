...
<!-- /print modal -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-gradient-info">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a class="btn btn-outline-light" id="print_btn"  href="{{url('/voucher/report2/'.session()->get('expense_id') )}}" target="_blank" >Yes</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
  ...
  <form role="form" id="purchase_demand" method="POST" action="{{url('/expense/save')}}">
            ...
            <div class="row">
              <div class="col-md-9">
                ...
                <div class="col-md-3 form-group">
                  ...
                  <input type="date" form="purchase_demand" name="voucher_date" id="voucher_date" onchange="setDocNo()" class="form-control select2" value="{{date('Y-m-d')}}" required style="width: 100%;">
                  </div>
                  ...
                  <select form="purchase_demand" name="pay_from" id="pay_from" class="form-control select2" required>

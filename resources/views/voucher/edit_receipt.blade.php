...
@section('content')
    ...
    <form role="form" id="purchase_demand" method="POST" action="{{url('/receipt/update')}}">
            ...
            <div class="row">
              <div class="col-md-9">
                ...
                <div class="col-md-3 form-group">
                  ...
                  <input type="date" form="purchase_demand" name="voucher_date" class="form-control select2" value="{{$payment['voucher_date']}}" id="voucher_date" onchange="setDocNo()" required style="width: 100%;">
                  </div>
                  ...
                  <input type="text" form="purchase_demand" name="reference" class="form-control select2" value="{{$payment['reference']}}"  style="width: 100%;">
                  </div>
    ...
    <div class="tab-pane fade show active" id="tabA">
      ...
      <table class="table table-bordered table-hover"  id="item_table" >
        ...
        <tbody id="selectedItems">
          ...
          <input type="hidden" form="purchase_demand" id="{{'debit_pivot_id'}}" name="debit_pivot_id" value="{{$payment['debit_transection']['pivot']['id']}}" readonly >

          <?php $row=1; ?>
            @foreach($payment['credit_transections'] as $acc)
...
<td><input type="text" class="form-control" value="{{$acc['pivot']['cheque_date']}}" form="purchase_demand" name="cheque_date[]" id="{{'cheque_date_'.$row}}" readonly ></td>
     ...
     <td><input type="text" class="form-control" value="{{$acc['pivot']['credit']}}" form="purchase_demand" name="amount[]" id="{{'amount_'.$row}}" readonly ></td>
...
<!-- End Tabs -->
    ...
    <form role="form" id="delete_form" method="POST" action="{{url('/delete/receipt/'.$payment['id'])}}">
     @csrf    
    </form>

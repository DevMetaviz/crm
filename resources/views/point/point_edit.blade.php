...
@section('content-header')
    ...
    <form role="form" method="POST" action="{{url('point/update')}}">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Point</h1>
            ...
            <a class="btn" href="{{url('point/list')}}" style="border: none;background-color: transparent;"><span class="fas fa-edit">&nbsp</span>Points</a>
          </div>
          <div class="col-sm-6">
            ...
            <div class="row">
              ...
              <fieldset class="border p-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" value="{{$point['name']}}" required style="width: 100%;">
                  </div>
                  ...
                  <select class="form-control select2" name="distributor_id" id="distributor_id" required  style="width: 100%;">
                    ...
                    <?php 
                       ...
                       $s='';
                         if($cus['id']==$point['distributor_id'])
                          $s='selected';
                     ?>
                ...
                <div class="form-group">
                  <label>Doctor</label>
                  <select class="form-control select2" name="doctor_id" id="doctor_id"   style="width: 100%;">
                    <option>------Select any value-----</option>
                    @foreach($doctors as $d)
                    <?php 

                       $s='';
                         if($d['id']==$point['doctor_id'])
                          $s='selected';
                     ?>
                    <option value="{{$d['id']}}" {{$s}}>{{$d['name']}}</option>
                    @endforeach
                ...
                <div class="form-row">
                  ...
                  <input type="text" name="contact" class="form-control" value="{{$point['contact']}}"   style="width: 100%;">
                  </div>

                  <div class="form-group col-sm-5">
                  <label>Mobile<span class="text-danger">*</span></label>
                  <input type="text" name="mobile" class="form-control" value="{{$point['mobile']}}"   style="width: 100%;">
                  </div>

                  <div class="form-group col-sm-7">
                  <label>Contact No 2<span class="text-danger">*</span></label>
                  <input type="text" name="contact2" class="form-control" value="{{$point['contact2']}}"   style="width: 100%;">
                  </div>

                  <div class="form-group col-sm-5">
                  <label>Mobile<span class="text-danger">*</span></label>
                  <input type="text" name="mobile2" class="form-control" value="{{$point['mobile2']}}"   style="width: 100%;">
                  </div>
                  ...
                  <input type="text" name="phone" class="form-control" value="{{$point['phone']}}"  style="width: 100%;">
                  ...
                  <input type="text" name="email" class="form-control" value="{{$point['email']}}"  style="width: 100%;">
                  </div>
                  ...
                  <textarea name="address" class="form-control">{{$point['address']}}</textarea>
                  </div>

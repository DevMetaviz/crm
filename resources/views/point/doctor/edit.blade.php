...
@section('content-header')
    ...
    <form role="form" method="POST" action="{{url('update/doctor')}}">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a class="btn" href="{{url('doctor/create')}}" style="border: none;background-color: transparent;"><span class="fas fa-edit">&nbsp</span>New</a>
            ...
            <div class="row">
              ...
              <fieldset class="border p-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" value="{{$doctor['name']}}" required style="width: 100%;">
                  </div>
                  ...
                  <select class="form-control select2" name="distributor_id" id="distributor_id" required  style="width: 100%;">
                    ...
                    <?php 
                       ...
                       $s='';
                         if($cus['id']==$doctor['distributor_id'])
                          $s='selected';
                     ?>
                    <option value="{{$cus['id']}}" {{$s}}>{{$cus['name']}}</option>
                    @endforeach
                ...
                <div class="form-row">
                  ...
                  <input type="text" name="contact" class="form-control" value="{{$doctor['contact']}}"   style="width: 100%;">
                  </div>

                  <div class="form-group col-sm-5">
                  <label>Mobile<span class="text-danger">*</span></label>
                  <input type="text" name="mobile" class="form-control" value="{{$doctor['mobile']}}"   style="width: 100%;">
                  </div>

                  <div class="form-group col-sm-7">
                  <label>Contact No 2<span class="text-danger">*</span></label>
                  <input type="text" name="contact2" class="form-control" value="{{$doctor['contact2']}}"   style="width: 100%;">
                  </div>

                  <div class="form-group col-sm-5">
                  <label>Mobile<span class="text-danger">*</span></label>
                  <input type="text" name="mobile2" class="form-control" value="{{$doctor['mobile2']}}"   style="width: 100%;">
                  </div>
                  ...
                  <input type="text" name="phone" class="form-control" value="{{$doctor['phone']}}"  style="width: 100%;">
                  ...
                  <input type="text" name="email" class="form-control" value="{{$doctor['email']}}"  style="width: 100%;">
                  </div>

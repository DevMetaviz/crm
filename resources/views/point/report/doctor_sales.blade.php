<html>
    ...
    <table width="100%" style="padding: 10px;" cellspacing="0">
        ...
        <tr  style="background-color: #03a9f4;"><td colspan="3"><p class="top-heading">Sale Report</p></td></tr>
         
        <tr class="">
            <td align="" style="width: 50%;">
               
                 
                <p style="text-transform: capitalize;" ><b>Distributor: </b>{{$distributor['name']}}</p>
            </td>
    ...
    <div style="height:30px;background-color: #03a9f4;"></div>
     ...
     <thead style="background-color:#03a9f4;">
        <tr>
            ...
            <th class="col1 col-wt-2">Doctor</th>
            <th class="item-name-th">Investment</th>
            <th class="col1 col-wt-2">Target Value</th>
            
            
            <th class="col1 col-wt-3">Sale Value</th>
     ...
     <?php 
        ...
        <tr>
         ...
         <td class="col bottom" style="text-transform: capitalize;">{{$doc['name']}}</td>
    
         
         <td class="item-name-col bottom">{{$invest}}</td>
         <td class="col bottom">{{$target}}</td>
          <td class="col bottom">{{$sale}}</td>

...
<form role="form" id="ticket_form" method="post" action="{{url('investment/update')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Investment</h1>
            <button type="Update" style="border: none;background-color: transparent;"><span class="fas fa-save">&nbsp</span>Update</button>
      ...
      <button type="button" class="close" data-dismiss="alert">&times;</button>
        {{ session()->get('success') }}
             ...
             <div id="std_error" style="display: none;"><p class="text-danger" id="std_error_txt"></p></div>
                ...
                <input type="hidden" form="ticket_form" value="{{$investment['id']}}" name="id" />
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="doc_no" class="form-control col-sm-8" value="{{$investment['doc_no']}}" required style="width: 100%;">
                  </div>
                 </div>
               ...
               <div class="col-sm-12">
                <div class="form-group row">
                  ...
                  <input type="date" form="ticket_form" name="investment_date" class="form-control col-sm-8" value="{{$investment['investment_date']}}" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <select form="ticket_form" name="invested_through" id="invested_through" class="form-control select2 col-sm-8">
                    ...
                    $s='';
                         if($emp['id']==$investment['invested_through'])
                          $s='selected';
                ...
                <div class="form-group row">
                  ...
                  <textarea form="ticket_form" name="remarks" class="form-control col-sm-8" style="width: 100%;">{{$investment['remarks']}}</textarea>
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <select form="ticket_form" name="doctor_id" id="doctor_id" class="form-control select2 col-sm-8" required >
                    ...
                    <?php 
                        $s='';
                         if($emp['id']==$investment['doctor_id'])
                          $s='selected';
                     ?>
                      <option value="{{$emp['id']}}" {{$s}} >{{$emp['name']}}</option>
                    @endforeach
                  </select>
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="number" step="any" min="1" form="ticket_form" name="amount" id="amount" class="form-control col-sm-8" value="{{$investment['amount']}}"    required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <textarea form="ticket_form" name="comment" class="form-control col-sm-8" style="width: 100%;">{{$investment['comment']}}</textarea>
                  </div>
                 </div>
...
value1="{{$investment['type'] }}";
 $('#type').val(value1);  

value1="{{$investment['activeness'] }}";
  ...
  $('#active').prop("checked", true);
    ...
    value1="{{$investment['is_invested'] }}";
   
   
   if(value1=="1")
   {
    
  $('#invested').prop("checked", true);
   
   }
    else{
      $('#invested').prop("checked", false);

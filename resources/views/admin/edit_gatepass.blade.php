...
@section('content-header')
    ...
    <form role="form" id="purchase_demand" method="POST" action="{{url('/gate-pass/update')}}">
          ...
          <div class="col-sm-6">
            ...
            <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="{{url('/gate-pass/report/'.$pass['id'])}}" class="dropdown-item">Print</a></li>
                    </ul>
                  </div>
          </div>
          <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" form="purchase_demand" name="doc_no" id="doc_no" class="form-control" value="{{$pass['doc_no']}}" readonly required style="width: 100%;">
                  </div>
                ...
                <div class="form-group">
                  <label>Date</label>
                  <input type="date" form="purchase_demand" name="doc_date" class="form-control" value="{{$pass['doc_date']}}" required style="width: 100%;">
                  </div>

                  <div class="form-group">
                  <input type="radio" form="purchase_demand" name="returnable" value="1" id="returnable" class="" >
              ...
              <div class="col-md-5">
                 ...
                 <fieldset class="border p-4">
                   <legend class="w-auto">Detail</legend>
                    ...
                    <div class="form-group">
                  <label>Name</label>
                  <input type="text" form="purchase_demand" name="name" class="form-control select2" value="{{$pass['name']}}" required style="width: 100%;">
                  </div>
                   
                  <div class="form-group">
                  <label>Vehicle #</label>
                  <input type="text" form="purchase_demand" name="vehicle" class="form-control" value="{{$pass['vehicle']}}" style="width: 100%;">
                  </div>
                    
                    <div class="row">
                    <div class="form-group col-md-6">
                  <label>Time Out</label>
                  <input type="time" form="purchase_demand" name="time_out" class="form-control" value="{{$pass['time_out']}}" style="width: 100%;">
                  </div>

                  <div class="form-group col-md-6">
                  <label>Time In</label>
                  <input type="time" form="purchase_demand" name="time_in" class="form-control" value="{{$pass['time_in']}}" style="width: 100%;">
                  </div>
                   </div>

                   <div class="form-group">
                  <label>Remarks</label>
                  <textarea name="remarks" form="purchase_demand" class="form-control" >{{$pass['remarks']}}</textarea>
                </div>
    ...
    <div class="tab-pane fade show active" id="tabA">
      ...
      <table class="table table-bordered table-hover table-head-fixed text-nowrap"  id="item_table" >
        ...
        <tbody id="selectedItems">
          ...
          <tr id="{{$row}}">
      <td ondblclick="editItem('{{$row}}')" style="text-align: center;">{{$i}}</td>
     
     <input type="hidden" value="{{$item['id']}}" form="purchase_demand" name="ids[]"  >
    

     <td ondblclick="editItem('{{$row}}')" ><input type="text" value="{{$item['item']}}" form="purchase_demand" name="items[]" id="{{'item_'.$row}}" required="true"></td>

      <td ondblclick="editItem('{{$row}}')" ><input type="number" value="{{$item['qty']}}" min="1" form="purchase_demand" name="qtys[]" id="{{'qty_'.$row}}"  required="true"></td>

      <td ondblclick="editItem('{{$row}}')" ><input type="text" value="{{$item['unit']}}" form="purchase_demand" name="units[]" id="{{'unit_'.$row}}" ></td>

      <td ondblclick="editItem('{{$row}}')" ><input type="text" value="{{$item['remarks']}}"  form="purchase_demand" name="rmrks[]" id="{{'rmrk_'.$row}}"  ></td>
         ...
         <td ondblclick="editItem('{{$row}}')" ><button type="button" class="btn" onclick="removeItem('{{$row}}')"><span class="fa fa-minus-circle text-danger"></span></button></td>
     </tr>
...
$(document).ready(function(){
  ...
  $('#active').prop("checked", true);
    ...
    var re = <?php echo json_encode($pass['returnable']); ?>

    $(`input[name=returnable][value=${re}]`).prop("checked",true);
...
function addItem()
{
  ...
  var unit=$("#unit").val();
    ...
    <input type="hidden" value="0" form="purchase_demand" name="ids[]"  >

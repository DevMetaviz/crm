...
@section('title', 'Item Shape Configuration')
@section('header-css')
...
<form role="form" method="post" action="{{url('configuration/inventory/color/save')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Item Shape Configuration</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Item Shape</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <div class="row">
                   ...
                   <legend class="w-auto">Add New Shape</legend>

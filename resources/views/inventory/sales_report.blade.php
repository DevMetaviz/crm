...
@section('content-header')
    <!-- Content Header (Page header) -->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Item Sales Report</h1>
        ...
        {{ session()->get('success') }}
         ...
         <div class="card">
              ...
              <div class="card-body">
                    ...
                    <form role="form" id="item_history_form" method="get" action="{{url('item-sales-report')}}">
              ...
              <div class="col-md-6">
                  ...
                  <select class="form-control select2" onchange="" name="customer_id" id="customer_id">
                    <option value="">Select any value</option>
                    
                    @foreach($customers as $depart)
                    
                    <option value="{{$depart['id']}}" {{ $depart['id'] == request('customer_id')  ? 'selected' : '' }} >{{$depart['name']}}</option>
                ...
                <table id="example1" class="table table-bordered table-striped table-hover " style="">
                  ...
                  <tr>
                   ...
                   <td>
                    ...
                    <a href="{{url('edit/sale/'.$record['invoice_id'])}}">{{$record['sale']['invoice_no']}}</a>
                   
                   </td>
                   <?php $date=date_create($record['sale']['invoice_date']);
                          $date=date_format($date,"d-M-Y");  ?>
                   <td>{{$date}}</td>
                   <?php $name='';
                      if(isset($record['sale']['customer']['name']))

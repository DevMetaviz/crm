<html>
    <head>
        ...
        <title>{{'Near Expirey Stock'}}</title>
        <style>
            /** 
    ...
    <table width="100%" style="padding: 10px;" cellspacing="0">
        ...
        <tr  style="background-color: #03a9f4;"><td colspan="3"><p class="top-heading">Near Expiry</p></td></tr>
         
        <tr class="">
            <td align="" style="width: 50%;">
               
                 
                <p style="text-transform: capitalize;" ><b>Department: </b>{{'Finished Goods'}}</p>
            </td>
            <?php
    ...
    <div style="height:30px;background-color: #03a9f4;"></div>
     ...
     <thead style="background-color:#03a9f4;">
        <tr>
            ...
            <th class="col1 col-wt-2">Batch No</th>
            
            
            <th class="col1 col-wt-3">Expiry Date</th>
     ...
     @foreach($items as $item)
      ...
      <?php 
        ...
        <tr>
         <td rowspan="{{$no}}" class="col bottom">{{$i}}</td>
    
      
    
         
         <td rowspan="{{$no}}" class="item-name-col bottom">{{$item['item']['item_name']}}</td>
         ...
         <td class="col bottom">{{$stk['batch_no']}}</td>
          <td class="col bottom">{{$stk['exp_date']}}</td>
          <td class="col bottom">{{$stk['current']}}</td>
          @if($k!=1)
                      </tr>
                        @endif

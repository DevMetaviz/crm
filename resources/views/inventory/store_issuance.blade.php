...
@section('content-header')
    ...
    <form role="form" id="ticket_form" method="POST" action="{{url('/issuance/save')}}">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">New Store Issuance</h1>
          ...
          <div id="std_error" style="display: none;"><p class="text-danger" id="std_error_txt"></p></div>
            ...
            <div class="row">
              <div class="col-md-8">
                ...
                <div class="form-group">
                  <input type="checkbox" name="issued" value="1" id="issued" class=""  checked>
                  <label>Issued</label>
                  </div>
                  ...
                  <div class="form-group">
                  <label>Plan No</label>
                  <input type="text" name="plan_no" id="plan_no"  class="form-control" value="{{$request['plan_no']}}" required style="width: 100%;" readonly>
                  <input type="hidden" name="plan_id" id="plan_id"  value="{{$request['plan_id']}}" >
                  </div>

                  <div class="form-group">
                  <label>Product</label>
                  <input type="text" name="product" id="product"  class="form-control" value="{{$request['product']}}" required style="width: 100%;" readonly>
                  </div>

                  <div class="form-group">
                  <label>Batch No.</label>
                  <input type="text" class="form-control" name="batch_no" id="batch_no"  style="width: 100%;" value="{{$request['batch_no']}}" readonly>
                  ...
                  <input type="text" name="batch_size" id="batch_size" class="form-control" value="{{$request['batch_size']}}" readonly style="width: 100%;">
                  </div>
                 ...
                 @endif
                  ...
                  <input type="text" name="request_no" id="request_no"  class="form-control" value="{{$request['doc_no']}}" required style="width: 100%;" readonly>
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="request_date" class="form-control" value="{{$request['doc_date']}}" readonly style="width: 100%;">
                  </div>
    ...
    <div id="item_add_error" style="display: none;"><p class="text-danger" id="item_add_error_txt"></p></div>
           ...
           <div class="col-md-2">
              ...
              <div class="col-md-2">
                    <div class="form-group">
                  <label>Batch No</label>
                  <input type="text"  form="add_item" name="item_batch_no" id="item_batch_no" class="form-control" readonly style="width: 100%;">
                </div>
              </div>  
...
$(document).ready(function(){
  ...
  var department_id='<?php echo $request['department_id'] ?>'; 
...
function addItem()
{
  ...
  if(stage_id==-1)
    stage_text='';
     ...
     if(item_id=='' ||  unit=='' || qty=='' || parseFloat(stock) < parseFloat(total))
     {
...
function updateItem(row)
{
  ...
  //var gross_total_qty=$("#gross_total_qty").val();
     ...
     if(item_id=='' ||  unit=='' || qty=='' )//|| parseFloat(stock) < parseFloat(total_qty)
     {
        var err_name='',err_unit='',err_qty='',err_stock='';

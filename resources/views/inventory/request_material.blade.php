...
@section('content-header')
    ...
    <form role="form" id="ticket_form" method="POST" action="{{url('/requisition/save')}}">
            ...
            <div class="row">
              <div class="col-md-5">
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="plan_no" class="form-control select2 col-sm-8" value="{{$plan_no}}" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="col-sm-12">
                  ...
                  <input type="text" form="ticket_form" name="ticket_no" class="form-control select2 col-sm-8" value="{{$ticket_no}}"  required style="width: 100%;">
                  </div>
                </div>
...
<div class="tab-content" style="background-color: white;border: 1px solid #dee2e6;padding: 10px;min-height:200px;">
    ...
    <span class="fa fa-plus-circle text-info"></span>
     ...
     <?php $row+=1; $total_qty+=$item['qty']; $total_net_qty+=($item['qty']*$item['pack_size']); ?>
     @endforeach

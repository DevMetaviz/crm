...
@section('title', 'Origin Configuration')
@section('header-css')
...
<form role="form" method="post" action="{{url('configuration/origin/save')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Origin Configuration</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Origin</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <div class="row">
                   ...
                   <legend class="w-auto">Add New Origin</legend>
                ...
                <div class="form-group">
                  <div class="row">
                    <div>
                  <label>Origin :<span class="text-danger">*</span>&nbsp</label>
                  </div>
                  <div>

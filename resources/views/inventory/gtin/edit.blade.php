...
<form role="form" method="post" action="{{url('gtin/update/'.$gtin['id'])}}">
        ...
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <div class="form-group row">
                  ...
                  <input type="text"  name="no" class="form-control col-sm-8" value="{{$gtin['gtin_no']}}"  required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text"  name="product" class="form-control col-sm-8" value="{{$gtin['product']['item_name']}}"  readonly="" style="width: 100%;">
                  </div>
                 </div>
                 @endif
                ...
                <div class="form-group row">
                  ...
                  <textarea name="remarks" class="form-control col-sm-8">{{$gtin['remarks']}}</textarea>
                  </div>
                 </div>
               </div>

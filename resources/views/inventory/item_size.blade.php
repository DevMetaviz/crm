...
@section('title', 'Shape Size Configuration')
@section('header-css')
...
<form role="form" method="post" action="{{url('configuration/inventory/size/save')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Shape Size Configuration</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Shape Size</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid" style="margin-top: 10px;">
         ...
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Shape Size</h3>
        ...
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <div class="row">
                   ...
                   <legend class="w-auto">Add New Size</legend>

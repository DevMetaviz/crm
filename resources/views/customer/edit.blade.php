            ...
            <div class="row">
              ...
              <div class="col-md-5">
                ...
                <!-- <fieldset class="border p-4">
                  ...
                  <input type="number" name="credit_days" class="form-control" value="{{$customer['credit_days']}}"  >
                 ...
                 <div class="form-group">
                  ...
                  <input type="number" name="credit_limits" class="form-control" value="{{$customer['credit_limits']}}"  >

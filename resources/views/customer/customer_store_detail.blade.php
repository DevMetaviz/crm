...
@section('title', 'Customer Store Detail')
@section('header-css')
...
@section('content-header')
    <!-- Content Header (Page header) -->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Customer Store Detail</h1>
        ...
        {{ session()->get('success') }}
         ...
         <div class="card">
              ...
              <div class="card-body">
                    ...
                    <form role="form" id="item_history_form" method="get" action="{{url('customer/store/detail')}}">

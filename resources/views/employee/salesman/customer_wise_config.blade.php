...
<form role="form" method="post" action="{{url('#')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Customer Wise Commission</h1>
        ...
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <div class="form-group row">
                  ...
                  <select name="so_id" id="so_id" class="form-control select2 col-sm-8" onchange="getCustomers()" required onchange="">
                ...
                <div class="form-group row">
                  ...
                  <select name="customer_id" id="customer_id" class="form-control select2 col-sm-8" required onchange="">
                    <option value="">Select any value</option>

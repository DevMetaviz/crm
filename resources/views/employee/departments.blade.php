...
@section('title', 'Department  Configuration')
@section('header-css')
...
<form role="form" method="post" action="{{url('save/department')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Department Configuration</h1>
            <button type="submit" style="border: none;background-color: transparent;"><span class="fas fa-save">&nbsp</span>Save</button>
            <button type="reset" style="border: none;background-color: transparent;"><span class="fas fa-edit">&nbsp</span>Clear</button>
            <a class="btn" href="{{url('department')}}" style="border: none;background-color: transparent;"><span class="fas fa-edit">&nbsp</span>New</a>
          </div>
          <div class="col-sm-6">
                ...
                <table id="example1" class="table table-bordered table-hover mt-4" style="">
                 ...
                 <tr>
                   ...
                   <th>Sort Order</th>
                    ...
                    @foreach($departments as $parameter)

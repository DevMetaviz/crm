   ...
   <div id="std_error" style="display: none;"><p class="text-danger" id="std_error_txt"></p></div>
            <div class="row">
              ...
              <div class="col-md-4">
                  ...
                  <select class="form-control select2" name="vendor_id" id="vendor_id" required onchange="setPos()">
...
<div class="tab-content" style="">
    <div class="tab-pane fade show active" id="tabA">
        ...
        <tr ondblclick="(editItem('{{$rows}}'))" id="{{$rows}}">
          ...
          <td><input type="text" form="purchase_order_form"  id="{{'item_name_'.$rows}}"  form="purchase_order_form" value="{{$item['name']}}" readonly ><input type="hidden" form="purchase_order_form"  id="{{'item_id_'.$rows}}" name="items_id[]" value="{{$item['id']}}" readonly ></td>
         
          <td><input type="text" form="purchase_order_form" id="variant_{{$rows}}"  value="{{$variants}}" readonly ><input type="hidden" form="purchase_order_form" id="variant_id_{{$rows}}" name="variant_ids[]" value="{{$item['variant_id']}}"  ></td>
         ...
         <!-- <td><input type="text" form="purchase_order_form" id="{{'uom_'.$rows}}" name="" value="{{$item['uom']}}" readonly ></td>-->
          ...
          <td><input type="number" step="any"  id="{{'qty_'.$rows}}" form="purchase_order_form" name="qtys[]" value="{{$item['quantity']}}"  ></td>
         ...
         {{--- 
          ...
          <td><input type="number" step="any" id="{{'rej_qty_'.$rows}}" form="purchase_order_form" name="rej_qty[]" value="{{$item['rej_qty']}}"  ></td>
           <td><input type="number" step="any" id="{{'gross_qty_'.$rows}}" form="purchase_order_form" name="gross_qty[]" value="{{$item['gross_qty']}}" readonly ></td>
        ...
        <tfoot class="table-secondary">
          <tr>
            ...
            <th></th>
             ...
             <!--<th></th>--->
            <th></th>
            <th id="net_qty">{{$grn['total_qty']}}</th>
            <!--<th id="net_rec_qty">0</th>-->
            <th></th>
            ...
            <!---<th id="net_rej_qty">0</th>-->
            <!--<th id="net_gross_qty">0</th>--->
            
            <th id="total_net_qty">{{$grn['total_net_qty']}}</th>
             <!--<th></th>--->
            <th></th>
          </tr>
        </tfoot>
 ...
 $("#item_code").val('');
  ...
  var rows=getRowNum();   
   ...
   var txt=`<tr ondblclick="(editItem(${rows}))" id="${rows}">
        <td><input type="hidden"  id="pivot_id_${rows}" name="pivot_ids[]" form="purchase_order_form" value="0"  ></td>
        <td><input type="text"  id="location_${rows}" name="locations[]" form="purchase_order_form" value="${location_text}" readonly ><input type="hidden"  id="location_id_${rows}" name="location_ids[]" form="purchase_order_form" value="${location}"  ></td>
        ...
        <td><input type="text" form="purchase_order_form" id="variant_${rows}" name="" value="${variants}" readonly ><input type="hidden" form="purchase_order_form" id="variant_id_${rows}" name="variant_ids[]" value="${variant_id}"  ></td>

             <td><input type="text" form="purchase_order_form"  id="unit_${rows}" name="units[]" value="${unit}" readonly ></td>

             <td><input type="number" step="any" id="qty_${rows}" form="purchase_order_form" name="qtys[]" value="${qty}"  ></td>
...
function loadPO()
{
  ...
  $.ajax({
       ...
       txt+=`<tr ondblclick="(editItem(${rows}))" id="${rows}">
        <td><input type="hidden"  id="pivot_id_${rows}" name="pivot_ids[]" form="purchase_order_form" value="0"  ></td>
        <td><input type="text"  id="location_${rows}" name="locations[]" form="purchase_order_form" value="${item['location']}" readonly ><input type="hidden"  id="location_id_${rows}" name="location_ids[]" form="purchase_order_form" value="${item['location_id']}"  ></td>
        ...
        <td><input type="text" form="purchase_order_form" id="variant_${rows}"  value="${variants}" readonly ><input type="hidden" form="purchase_order_form" id="variant_id_${rows}" name="variant_ids[]" value="${item['variant_id']}"  ></td>
             ...
             <td><input type="number" step="any" id="qty_${rows}" form="purchase_order_form" name="qtys[]" value="${item['qty']}"  ></td>

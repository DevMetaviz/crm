    ...
    @section('header-title', 'Purchase Return')
    ...
    <p><b>Return No:</b>&nbsp;&nbsp;&nbsp;{{$order['doc_no']}} </p>

    <p><b>Return Date: </b>{{$order['doc_date']}}</p>

    <p><b>Invoice No:</b>&nbsp;&nbsp;&nbsp;{{$order['purchase']['doc_no']}} </p>

    <p><b>Invoice Date: </b>{{$order['purchase']['doc_date']}}</p>
    ...
    <th class="col">{{$order->total_qty()}}</th>

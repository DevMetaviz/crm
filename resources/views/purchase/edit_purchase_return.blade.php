...
@section('title', 'Edit Invoice Return')
@section('header-css')
<style type="text/css">
  .alert-success {
     color: #155724; 
...
<form role="form" id="delete_form" method="POST" action="{{url('purchase/return/delete/'.$return['id'])}}">
               
               @csrf    
    </form>

    <!-- Content Header (Page header) -->
  <form role="form" id="purchase_order_form" method="POST" action="{{url('update/purchase/return')}}">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Edit Invoice Return</h1>
            ...
            <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="{{url('/purchase/return/report/'.$return['id'])}}" class="dropdown-item">Print</a></li>
                    </ul>
                  </div>
          </div>
          <!-- /.delete modal -->
      ...
      <!-- /.delete modal -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Invoice Return</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="purchase_no" class="form-control" value="{{$return['doc_no']}}" required readonly style="width: 100%;">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                   ...
                   <select class="form-control select2" name="purchase_id" id="purchase_id">
                    ...
                    @if($purchase!='')
                    <option value="{{$purchase['id']}}" selected>{{$purchase['doc_no'].'~~ '.$purchase['doc_date']}}</option>
                    @endif
 ...
 -->
              ...
              <div class="col-md-3">
                 ...
                 <fieldset class="border p-4">
                  ...
                  <input type="number" step="any" name="net_discount" id="net_discount" class="form-control" value="{{$return['net_discount']}}" onchange="setNetTaxAndExpense()" style="width: 100%;">
                  </div>
                  </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                  <label>GST %</label>
                  <input type="number" step="any" name="gst" id="gst" class="form-control" value="{{$return['gst_tax']}}" onchange="setNetTaxAndExpense()" style="width: 100%;">
                  </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" step="any" name="gst_amount" id="gst_amount" class="form-control" value="" readonly style="width: 100%;">
                    ...
                    <div class="form-group">
                  <label>W.H Tax %</label>
                  <input type="number" step="any" name="net_tax" id="net_tax" class="form-control" value="{{$return['net_tax']}}" onchange="setNetTaxAndExpense()" style="width: 100%;">
                  </div>
                  </div> 
...
<div class="tab-content" style="background-color: white;border: 1px solid #dee2e6;padding: 10px;">
   ...
   <div id="item_add_error" style="display: none;"><p class="text-danger" id="item_add_error_txt"></p></div>
                 ...
                 elseif($current_rate==null && $pack_rate==null)
                  ...
                  $d=($item['discount'] / 100) *  $rate ;
                    ...
                    $total=$d_rate * $total_qty;
                     ...
                     $grn_no='';
                     if($item['purchase_stock']!='')
                      if($item['purchase_stock']['stock']!='')
                        $grn_no=$item['purchase_stock']['stock']['grn_no'];

                 ?>

          <tr ondblclick="(editItem('{{$rows}}'))" id="{{$rows}}"><td><input type="hidden"  id="{{'pivot_id_'.$rows}}" name="pivot_ids[]" form="purchase_order_form" value="{{$pivot_id}}"  ></td><td><input type="text"  id="{{'location_'.$rows}}" name="locations[]" form="purchase_order_form" value="{{$item['item']['department']['name']}}" readonly ><input type="hidden"  id="{{'location_id_'.$rows}}" name="location_ids[]" form="purchase_order_form" value="{{$item['item']['department_id']}}"  ></td><td><input type="text" form="purchase_order_form"  id="{{'code_'.$rows}}" name="codes[]" value="{{$item['item']['item_code']}}" readonly ></td><td><input type="text" form="purchase_order_form"  id="{{'item_name_'.$rows}}" name="items_name[]" form="purchase_order_form" value="{{$item['item']['item_name']}}" readonly ><input type="hidden" form="purchase_order_form"  id="{{'item_id_'.$rows}}" name="items_id[]" value="{{$item['item']['id']}}" readonly ></td>
              
          <td><input type="text" form="purchase_order_form"  id="{{'item_grn_'.$rows}}" name="items_grn[]" form="purchase_order_form" value="{{$grn_no}}" readonly ><input type="hidden" form="purchase_order_form"   name="items_stock[]"  value="{{$item['purchase_stock_id']}}"  ></td>
     ...
     <td><input type="text" form="purchase_order_form"  id="{{'unit_'.$rows}}" name="units[]" value="{{$item['unit']}}" readonly ></td>
       ...
       <td><input type="text"  id="{{'p_qty_'.$rows}}" form="purchase_order_form" name="p_qtys[]" value="{{$item['p_qty']}}" readonly ></td>
   ...
   <div id="expense_add_error" style="display: none;"><p class="text-danger" id="expense_add_error_txt"></p></div>
              ...
              <div class="col-md-1">
                ...
                <div class="form-group row">
                  ...
                  <?php $exp_row=1; ?>
                 <?php //@foreach($return['expenses'] as $exp) ?>
...
function loadPurchase()
{
  ...
  $.ajax({
     ...
     <td><input type="text"  id="color_${rows}" form="purchase_order_form" name="" value="${color}" readonly ></td><td><input type="text" form="purchase_order_form" id="size_${rows}" name="" value="${size}" readonly ></td><td><input type="text" form="purchase_order_form" id="uom_${rows}" name="" value="${uom}" readonly ></td>
     <td><input type="text" form="purchase_order_form"  id="unit_${rows}" name="units[]" value="${unit}" readonly ></td>

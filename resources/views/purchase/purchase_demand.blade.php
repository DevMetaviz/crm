...
@section('title', 'New Purchase Demand')
@section('header-css')
    ...
    <!-- Content Header (Page header) -->
       ...
       <div class="row default-header"  >
          ...
          <div class="col-sm-6 text-right">
            ...
            <a class="btn btn-transparent" href="{{url('purchase/demand/history')}}" ><span class="fas fa-history">&nbsp</span>History</a>
...
<form role="form" id="purchase_demand" method="POST" action="{{url('/purchase/demand/save')}}">
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <div class="form-group">
                  <label>Doc No.</label>
                  <input type="text" form="purchase_demand" name="doc_no" class="form-control" value="{{$doc_no}}" readonly required style="width: 100%;">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" form="purchase_demand" name="required_date" class="form-control" value="" required style="width: 100%;">
                  </div>

                <div class="form-group">
                  <input type="checkbox" form="purchase_demand" name="posted" value="posted" id="posted" class=""  checked>
                  <label>Posted</label>
                  </div>
    ...
    <div id="item_add_error" style="display: none;"><p class="text-danger" id="item_add_error_txt"></p></div>
        ...
        <input class="form-control"  name="item_code" id="item_code">
              ...
              <div class="col-md-1">
                  ...
                  <input type="number" min="1" value="1" step="1"  form="add_item" name="p_s" id="p_s" value="1"  onchange="setTotalQty()" class="form-control " readonly required="true" style="width: 100%;">
                </div>
              </div>

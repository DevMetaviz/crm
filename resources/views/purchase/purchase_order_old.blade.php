...
<div id="std_error" style="display: none;"><p class="text-danger" id="std_error_txt"></p></div>
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <input type="date" name="due_date" class="form-control  col-sm-8" value=""  style="width: 100%;">
                  </div>
              ...
              <div class="col-md-4">
                  ...
                  <textarea name="vendor_address" id="vendor_address" class="form-control" readonly ></textarea>
                </div>

                <div class="form-group">
                  <label>Vendor Mobile</label>
                <input type="text" class="form-control" name="vendor_phone" id="vendor_phone" readonly >
                </div>
...
function addItem(button) {
 ...
 <td><input type="text" form="purchase_order_form"  id="item_variant_${rows}"  form="purchase_order_form" value="${variants}" readonly ><input type="hidden" form="purchase_order_form"  id="item_variant_id_${rows}" name="variant_ids[]" value="${variant_id}" readonly ></td>
           ...
           <td><input type="text"  id="qty_${rows}" form="purchase_order_form" name="qtys[]" value="${qty}"  ></td>
     <td><input type="text"  id="p_s_${rows}" form="purchase_order_form" name="p_s[]" value="${p_s}" readonly ></td>
     <td><input type="text"  id="total_qty_${rows}" form="purchase_order_form" name="total_qty[]" value="${total}" readonly ></td>

       <td><input type="text" form="purchase_order_form" id="unit_rate_${rows}" name="unit_rate[]" value="${unit_rate}"  ></td>
       <td><input type="text" form="purchase_order_form" id="pack_rate_${rows}" name="pack_rate[]" value="${pack_rate}"  ></td>
       <td><input type="text" form="purchase_order_form" id="disc_${rows}" name="disc[]" value="${disc}"  ></td>

          
          <td><input type="text" form="purchase_order_form" id="tax_${rows}" name="tax[]" value="${tax}"  ></td>
...
function loadDemand()
{
 ...
 <td><input type="text" form="purchase_order_form"  id="item_variant_${rows}"  form="purchase_order_form" value="${variants}" readonly ><input type="hidden" form="purchase_order_form"  id="item_variant_id_${rows}" name="variant_ids[]" value="${item['variant_id']}" readonly ></td>
           ...
           <td><input type="text"  id="qty_${rows}" form="purchase_order_form" name="qtys[]" value="${item['qty']}"  ></td>
     ...
     <td><input type="text"  id="total_qty_${rows}" form="purchase_order_form" name="total_qty[]" value="${item['total_qty']}" readonly ></td>
       ...
       <td><input type="text" form="purchase_order_form" id="unit_rate_${rows}" name="unit_rate[]" value=""  ></td>
       <td><input type="text" form="purchase_order_form" id="pack_rate_${rows}" name="pack_rate[]" value=""  ></td>
       <td><input type="text" form="purchase_order_form" id="disc_${rows}" name="disc[]" value=""  ></td>

          
          <td><input type="text" form="purchase_order_form" id="tax_${rows}" name="tax[]" value=""  ></td>
          <td><input type="text"  id="net_total_${rows}" form="purchase_order_form" name="net_total[]" value="" readonly ></td>

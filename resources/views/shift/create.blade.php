...
@section('content-header')
    ...
    <form role="form" method="POST" action="{{url('/define/shift')}}">
      <input type="hidden" value="{{csrf_token()}}" name="_token"/>

      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Define Shift</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Define Shift</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <button type="button" class="close" data-dismiss="alert">&times;</button>
        {{ session()->get('success') }}
            ...
            <div class="form-group">
                  ...
                  <input type="text" name="shift_name" class="form-control select2" value="{{old('shift_name')}}" required style="width: 100%;">
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="time" name="start_time" class="form-control select2" value="{{old('start_time')}}" style="width: 100%;" required>
                  </div>

                   <div class="form-group">
                  <label>Relaxation</label>
                  <input type="number" name="relaxation" min="0" max="120" value="{{old('relaxation')}}" class="form-control select2" style="width: 100%;" required>
                  </div>
                <!-- /.form-group -->
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="time" name="end_time" class="form-control select2" value="{{old('end_time')}}" style="width: 100%;" required>
                </div>
              ...
              <div class="col-md-3">
                  ...
                  <div class="form-group">
                  <input type="checkbox" name="late_deduction" value="1" id="late_deduction" class=""  checked>
         ...
         <div class="col-md-2">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="number" min="0" max="31" value="0" step="any" name="{{$leave['id']}}"  class="form-control select2" style="width: 100%;">
                </div>
                <!-- /.form-group -->

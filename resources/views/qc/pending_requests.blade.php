        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#">QA Samplings</a></li>
              <li class="breadcrumb-item active">Pending Samplings</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid" style="margin-top: 10px;">
         ...
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pending Samplings</h3>
                ...
                <table id="example1" class="table table-bordered table-hover mt-4" style="">
                 ...
                 @foreach($requests as $req)
                    ...
                    <td>{{$req['total_qty']}}</td>
                     ...
                     <td><a href="{{url('/sampling/'.$req['id'])}}"><span class="fa fa-edit"></span></a></td>

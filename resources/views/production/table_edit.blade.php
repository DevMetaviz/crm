...
@section('content-header')
    ...
    <form role="form" id="production_process"  method="POST" action="{{url('update/configuration/table')}}">
            ...
            <div class="row">
              <div class="col-md-5">
                ...
                <div class="form-row">
                  ...
                  <input type="text" form="production_process" name="name" class="form-control select2 col-sm-8" value="{{$table['name']}}"  style="width: 100%;">
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  ...
                  <input type="text" form="production_process" name="identity" class="form-control select2 col-sm-8" value="{{$table['identity']}}" required style="width: 100%;">
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  ...
                  <input type="number" form="production_process" name="no_of_rows" class="form-control select2 col-sm-8" min="1" value="{{$table['no_of_rows']}}" required style="width: 100%;">
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  ...
                  <input type="number" form="production_process" name="sort_order" class="form-control select2 col-sm-8" min="1" value="{{$table['sort_order']}}" required style="width: 100%;">
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  ...
                  <label><input type="checkbox" form="production_process" name="activeness" value="1" id="activeness" class=""  >&nbsp&nbspActive</label>
                  </div>
                  </div>
                </div>
              ...
              <!-- /.col -->
               ...
               <div class="col-md-3">
                  ...
                  <fieldset class="border p-4">
                   ...
                   <textarea class="form-control select2" form="production_process" name="remarks">{{$table['remarks']}}</textarea>
                 </fieldset>
               </div>
   ...
   <div class="tab-pane fade show active" id="tabA">
      ...
      <table class="table" id="columns_table">
        ...
        <tbody id="columns_body">
          ...
          <tr ondblclick="()" id="{{$row}}">
            <td><input type="hidden" form="production_process" name="col_ids[]" id="{{'col_id_'.$row}}" value="{{$col['id']}}"></td>
            
            <td><input type="text" form="production_process" id="{{'heading_'.$row}}" name="headings[]" value="{{$col['heading']}}" readonly ></td>
            <td><input type="text" form="production_process" id="{{'type_'.$row}}" name="types[]" value="{{$col['type']}}" readonly ></td>
     <td><input type="text" form="production_process" id="{{'footer_type_'.$row}}" name="footer_types[]" value="{{$col['footer_type']}}" readonly ></td>
     <td><input type="text" form="production_process" id="{{'footer_text_'.$row}}" name="footer_texts[]" value="{{$col['footer_text']}}" readonly ></td>
       <td><input type="text" form="production_process" name="sort_orders[]" id="{{'sort_order_'.$row}}" value="{{$col['sort_order']}}" readonly></td>
       
       <td><button type="button" class="btn" onclick="removeTable('{{$row}}')"><span class="fa fa-minus-circle text-danger"></span></button></td></tr>
...
if(active=="1")
  ...
  $('#activeness').prop("checked", true);
    ...
    $('#process_id').val('{{$table['process_id']}}');
...
function add_table()
{
  ...
  var footer_type=$("#footer_type option:selected").val();
     ...
     else
     {
      ...
      if(err_exist=='')
      {  //editTable(${rows})
     var txt=`<tr ondblclick="()" id="${rows}"><td><input type="hidden" form="production_process" id="col_id_${rows}" name="col_ids[]" value="0" readonly ></td><td><input type="text" form="production_process" id="heading_${rows}" name="headings[]" value="${heading}" readonly ></td><td><input type="text" form="production_process" id="type_${rows}" name="types[]" value="${type}" readonly ></td>

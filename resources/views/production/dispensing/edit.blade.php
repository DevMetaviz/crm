...
<form role="form" id="ticket_form" method="post" action="{{url('dispensing/update')}}">
        ...
        <div class="row mb-2">
          ...
          <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="{{url('print/dispensing/'.$dispensing['id'])}}" class="dropdown-item">Print</a></li>
                    </ul>
                  </div>
    ...
    <div class="alert alert-success alert-dismissible col-md-3">
      <button type="button" class="close" data-dismiss="alert">&times;</button>
        {{ session()->get('success') }}
          ...
          <input type="hidden" form="ticket_form" value="{{$dispensing['id']}}" name="id"/>
                ...
                <div class="form-group row">
                  <label class="col-md-4">Plan No</label>
                  <select form="ticket_form" class="select2 form-control col-md-8 "   name="plan_id" id="plan_id" onchange="setPlanAtt()" required >
                ...
                <div class="form-group row">
                  ...
                  <input type="datetime-local"  form="ticket_form" name="dispense_start" id="dispense_start" class="form-control col-sm-8" value="{{ date('Y-m-d\TH:i', strtotime($dispensing['dispense_start'])) }}" onchange="set_total_total()"  style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="datetime-local" form="ticket_form" name="dispense_comp" id="dispense_comp" class="form-control col-sm-8" value="{{ date('Y-m-d\TH:i', strtotime($dispensing['dispense_comp'])) }}" onchange="set_total_total()" style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="dispene_total" id="dispene_total" class="form-control  col-sm-8" value=""  readonly style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="temprature" id="temprature" class="form-control  col-sm-8" value="{{$dispensing['temprature']}}" required   style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text"  form="ticket_form" name="humidity" id="humidity" class="form-control  col-sm-8" value="{{$dispensing['humidity']}}" style="width: 100%;">
                  </div>
                 </div>
...
$('.select2').select2(); 
   ...
   var plan_id="{{$dispensing['plan_id']}}";
$('#plan_id').val(plan_id);

...
<form role="form" id="ticket_form" method="post" action="{{url('granulation/update')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a class="btn" href="{{url('/granulation')}}" style="border: none;background-color: transparent;"><span class="fas fa-edit">&nbsp</span>New</a>
          ...
          <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="{{url('print/granulation/'.$granulation['id'])}}" class="dropdown-item">Print</a></li>
                    </ul>
                  </div>
    ...
    <div class="alert alert-success alert-dismissible col-md-3">
      <button type="button" class="close" data-dismiss="alert">&times;</button>
        {{ session()->get('success') }}
          ...
          <input type="hidden" form="ticket_form" value="{{$granulation['id']}}" name="id"/>
                ...
                <div class="form-group row">
                  ...
                  <input type="datetime-local"  form="ticket_form" name="grn_start" id="grn_start" class="form-control col-sm-8" value="{{ date('Y-m-d\TH:i', strtotime($granulation['grn_start'])) }}" onchange="set_grn_total()" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="datetime-local" form="ticket_form" name="grn_comp" id="grn_comp" class="form-control col-sm-8" value="{{ date('Y-m-d\TH:i', strtotime($granulation['grn_comp'])) }}" onchange="set_grn_total()" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="lead_time" id="lead_time" class="form-control  col-sm-8" value="{{$granulation['lead_time']}}" required   style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="temprature" id="temprature" class="form-control  col-sm-8" value="{{$granulation['temprature']}}" required   style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text"  form="ticket_form" name="humidity" id="humidity" class="form-control  col-sm-8" value="{{$granulation['humidity']}}" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="time"  form="ticket_form" name="sev_start" id="sev_start" class="form-control  col-sm-8" value="{{$granulation['sev_start']}}" required onchange="setSevTime()" style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="time" form="ticket_form" name="sev_complete" id="sev_complete" class="form-control  col-sm-8" value="{{$granulation['sev_complete']}}" onchange="setSevTime()" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="number" step="any" form="ticket_form" name="sev_num" id="sev_num" class="form-control  col-sm-8" value="{{$granulation['sev_num']}}" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  <label class="col-sm-4">Total Time</label>
                  <input type="text" form="ticket_form" name="dry_time" id="dry_time" class="form-control  col-sm-8" value="{{$granulation['dry_time']}}" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="dry_temp" id="dry_temp" class="form-control  col-sm-8" value="{{$granulation['dry_temp']}}" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="time" form="ticket_form" name="mixing_start_time" id="mixing_start_time" class="form-control  col-sm-8" value="{{$granulation['mixing_start_time']}}" onchange="setMixTime()" required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="time" form="ticket_form" name="mixing_complete_time" id="mixing_complete_time" class="form-control  col-sm-8" value="{{$granulation['mixing_complete_time']}}" onchange="setMixTime()" required style="width: 100%;">
                  </div>
                 </div>
...
<div class="nav-tabs-wrapper">
    <ul class="nav nav-tabs dragscroll horizontal">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#tabE">Yield Calculation</a></li>
    </ul>
</div>
     ...
     <div class="table-responsive">
      <table class="table table-bordered table-hover "  id="item_table" >
        ...
        <?php $row=1; ?>
             ...
             @foreach($granulation['containers'] as $item)
...
$('.select2').select2(); 
   ...
   var plan_id="{{$granulation['plan_id']}}";
$('#plan_id').val(plan_id);

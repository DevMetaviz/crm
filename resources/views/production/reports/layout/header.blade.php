 ...
 <header>
          ...
          <div style="border: 1px solid black;padding:3px; ">
            <table class="" id="head_table" style="" cellspacing ="2">
                ...
                <tr>
                    <td rowspan="2" style="width: 30%">PRODUCT NAME:<br>{{$ticket_process['ticket']['product']['item_name']}}</td>
                    <td style="width: 40%">BATCH SIZE :{{$ticket_process['ticket']['batch_size'].' TABLETS'}}</td>
                    <td style="width: 30%">BATCH NO :{{$ticket_process['ticket']['batch_no']}}</td>
                </tr>

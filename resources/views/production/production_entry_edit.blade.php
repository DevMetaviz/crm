      ...
      <button type="button" class="close" data-dismiss="alert">&times;</button>
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <input type="hidden" form="ticket_form" value="{{$production['id']}}" name="production_id"/>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="code" class="form-control select2 col-sm-8" value="{{$production['code']}}" readonly required style="width: 100%;">
                  </div>
                 </div>
                  
                  @if(isset($production['ticket']))
                  <div class="col-sm-6">
                <div class="form-group row">
                  <label class="col-sm-4">Plan No.</label>
                  <input type="text" form="ticket_form" name="plan_no" class="form-control select2 col-sm-8" value="{{$production['ticket']['plan']['plan_no']}}" readonly required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="ticket_no" class="form-control select2 col-sm-8" value="{{$production['ticket']['ticket_no']}}" readonly required style="width: 100%;">
                  </div>
                 </div>
                 @endif
             ...
             <input class="form-control" form="ticket_form"  name="item" id="item_code" onchange="setUom()">
                 ...
                 <?php 
                      $unit=$production['item']['unit'];
                      if($unit!='')
                        $unit=$production['item']['unit']['name'];
                  ?>

                 <div class="col-sm-6">
                <div class="form-group row">
                  <label class="col-sm-4">UOM</label>
                  <input type="text" form="ticket_form" name="uom" class="form-control select2 col-sm-8" value="{{$unit}}" readonly required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="batch_no" class="form-control select2 col-sm-8" value="{{$production['batch_no']}}" readonly  style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="date" form="ticket_form" name="production_date" class="form-control select2 col-sm-8" value="{{$production['production_date']}}"  required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="date" form="ticket_form" name="mfg_date" class="form-control select2 col-sm-8" value="{{$production['mfg_date']}}"   style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="date" form="ticket_form" name="exp_date" class="form-control select2 col-sm-8" value="{{$production['exp_date']}}"   style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="number" form="ticket_form" name="mrp" step="any" class="form-control select2 col-sm-8" value="{{$production['mrp']}}"   style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="number" form="ticket_form" min="1" value="{{$production['qty']}}" name="qty" id="qty" class="form-control select2 col-sm-8" onchange="setTotalQty()"   required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="number" form="ticket_form" name="p_s" id="p_s"   onchange="setTotalQty()" class="form-control select2 col-sm-8" value="{{$production['pack_size']}}" min="1" readonly required style="width: 100%;">
                  </div>
                 </div>
                 ...
                 <?php 
                  ...
                  $total=$production['pack_size'] * $production['qty'] ;
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="total_qty" id="total_qty" min="1" class="form-control select2 col-sm-8" value="{{$total}}" readonly required style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="number" step="any" form="ticket_form" name="cost_price" id="cost_price" min="0" class="form-control select2 col-sm-8" value="{{$production['cost_price']}}" required style="width: 100%;">
                  </div>
                 </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {  
      ...
      var unit="{{ $production['unit'] }}";
           $('#unit').val(unit);

     setPackSize();
     
      var active="{{ $production['activeness'] }}";
      ...
      var department_id="<?php if(isset($production['item_id'])) echo $production['item']['department_id'] ; else echo '' ; ?>";
      
      var item_id="<?php  echo $production['item_id'] ;  ?>";
      var item="<?php if(isset($production['item_id'])) echo $production['item']['item_name'] ; else echo '' ; ?>";

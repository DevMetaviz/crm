...
<form role="form" id="ticket_form" method="post" action="{{url('coating/save')}}">
      ...
      <button type="button" class="close" data-dismiss="alert">&times;</button>
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <div class="form-group row">
                  ...
                  <input type="datetime-local"  form="ticket_form" name="start_date" id="start_date" class="form-control col-sm-8" value="" onchange="set_total()"  style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="datetime-local" form="ticket_form" name="comp_date" id="comp_date" class="form-control col-sm-8" value="" onchange="set_total()" style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="mix_time" id="mix_time" class="form-control  col-sm-8" value="" required  style="width: 100%;">
                  </div>
                 </div>
        ...
        <tbody>
           ...
           <tr>
             ...
             <td><input type="text" form="ticket_form" name="inlet_temperature"   class="form-control" value="" required style="width: 100%;"></td>
           </tr>

           <tr>
             <td>Bed Temperature</td>
             <td>40 – 50<sup>o</sup>C</td>
             <td><input type="text" form="ticket_form" name="bed_temperature"   class="form-control" value="" required style="width: 100%;"></td>
           </tr>
            
            <tr>
             <td>Outlet Temperature</td>
             <td>65 – 75<sup>o</sup>C</td>
             <td><input type="text" form="ticket_form" name="outlet_temperature"   class="form-control" value="" required style="width: 100%;"></td>
           </tr>
          
          <tr>
             <td>Machine Speed</td>
             <td>2 – 5 rpm</td>
             <td><input type="text" form="ticket_form" name="machine_speed"   class="form-control" value="" required style="width: 100%;"></td>
           </tr>
            ...
            <tr>
             ...
             <td>10 – 18 inches</td>
             <td><input type="text" form="ticket_form" name="distance_spray_gun"   class="form-control" value="" required style="width: 100%;"></td>
           </tr>         

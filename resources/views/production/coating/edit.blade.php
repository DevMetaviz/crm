...
<form role="form" id="ticket_form" method="post" action="{{url('coating/update')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Coating</h1>
            ...
            <a class="btn" href="{{url('/coating')}}" style="border: none;background-color: transparent;"><span class="fas fa-edit">&nbsp</span>New</a>
            <a class="btn" href="{{url('/coating/history')}}" style="border: none;background-color: transparent;"><span class="fas fa-edit">&nbsp</span>History</a>
            ...
            <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="{{url('print/coating/'.$coating['id'])}}" class="dropdown-item">Print</a></li>
                    </ul>
                  </div>
      ...
      <div class="container-fluid" style="margin-top: 10px;">
         ...
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Coating</h3>
      ...
      <button type="button" class="close" data-dismiss="alert">&times;</button>
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <input type="hidden" form="ticket_form" value="{{$coating['id']}}" name="id"/>
                ...
                <div class="form-group row">
                  ...
                  <input type="datetime-local"  form="ticket_form" name="start_date" id="start_date" class="form-control col-sm-8" value="{{ date('Y-m-d\TH:i', strtotime($coating['start_date'])) }}" onchange="set_total()"  style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="datetime-local" form="ticket_form" name="comp_date" id="comp_date" class="form-control col-sm-8" value="{{ date('Y-m-d\TH:i', strtotime($coating['comp_date'])) }}" onchange="set_total()" style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="lead_time" id="lead_time" class="form-control  col-sm-8" value="{{$coating['lead_time']}}" required   style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text" form="ticket_form" name="temprature" id="temprature" class="form-control  col-sm-8" value="{{$coating['temprature']}}" required   style="width: 100%;">
                  </div>
                 </div>
                ...
                <div class="form-group row">
                  ...
                  <input type="text"  form="ticket_form" name="humidity" id="humidity" class="form-control  col-sm-8" value="{{$coating['humidity']}}" required style="width: 100%;">
                  </div>
                 </div>

                 <div class="bg-info p-1 m-1 col-sm-12">
                        <h3>Coating Solution Preparation</h3>
                    </div>
                 ...
                 <div class="col-sm-4">
                <div class="form-group row">
                  <label class="col-sm-4">Total Mixing Time</label>
                  <input type="text" form="ticket_form" name="mix_time" id="mix_time" class="form-control  col-sm-8" value="{{$coating['mix_time']}}" required  style="width: 100%;">
                  </div>
                 </div>

                 <p class="col-sm-12" style="display: block;">Apply the coating solution to the core tablet and adjust the following parameters:</p>
        ...
        <tbody>
           ...
           <tr>
             ...
             <td><input type="text" form="ticket_form" name="inlet_temperature"   class="form-control" value="{{$coating['inlet_temperature']}}" required style="width: 100%;"></td>
           </tr>

           <tr>
             <td>Bed Temperature</td>
             <td>40 – 50<sup>o</sup>C</td>
             <td><input type="text" form="ticket_form" name="bed_temperature"   class="form-control" value="{{$coating['bed_temperature']}}" required style="width: 100%;"></td>
           </tr>
            
            <tr>
             <td>Outlet Temperature</td>
             <td>65 – 75<sup>o</sup>C</td>
             <td><input type="text" form="ticket_form" name="outlet_temperature"   class="form-control" value="{{$coating['outlet_temperature']}}" required style="width: 100%;"></td>
           </tr>
          
          <tr>
             <td>Machine Speed</td>
             <td>2 – 5 rpm</td>
             <td><input type="text" form="ticket_form" name="machine_speed"   class="form-control" value="{{$coating['machine_speed']}}" required style="width: 100%;"></td>
           </tr>
            ...
            <tr>
             ...
             <td>10 – 18 inches</td>
             <td><input type="text" form="ticket_form" name="distance_spray_gun"   class="form-control" value="{{$coating['distance_spray_gun']}}" required style="width: 100%;"></td>
           </tr>         
      ...
      <table class="table table-bordered table-hover "  id="item_table" >
        ...
        <tbody id="selectedItems">
         ...
         <?php $row=1; ?>
             ...
             @foreach($coating['containers'] as $item)

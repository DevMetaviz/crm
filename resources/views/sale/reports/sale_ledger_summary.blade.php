        ...
        {{ session()->get('success') }}
         ...
         <div class="card">
              ...
              <div class="card-body">
                    ...
                    <form role="form" id="item_history_form" method="get" action="{{url('sale/ledger/summary/')}}">
              ...
              <div class="col-md-2">
                ...
                <table id="example1" class="table table-bordered table-hover " style="">
                  ...
                  <?php 
                   ...
                   $amount=$record->amount_ex_discount();
                   $disc=$record->net_discount();
                   $gst=$record->gst_amount();
                   $exp=$record->expense_amount();
                  ...
                  <tr>
                   ...
                   <td>{{$i}}</td>
                   <td><a href="{{url('edit/sale/'.$record['id'])}}">{{$record['invoice_no']}}</a></td>
                   <td>{{$record['invoice_date']}}</td>
                   <td>@if($record['customer']!=''){{$record['customer']['name']}}@endif</td>
                    <td>@if($record['customer']!=''){{$record['customer']['ntn']}}@endif</td>

                     <td>@if($record['customer']!=''){{$record['customer']['cnic']}}@endif</td>                                                                          
                   <td>{{$qty}}</td>
                   <td>{{$amount}}</td>
                   <td>{{$disc}}</td>
                   <td>@if($record['gst']!=''){{$record['gst'].'%'}}@endif</td>
                   <td>{{$gst}}</td>
                   <td>{{$exp}}</td>
                   <td>{{$net}}</td> 

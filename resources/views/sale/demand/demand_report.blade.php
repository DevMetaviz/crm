<html>
    ...
    <body>
        ...
        <tr style="background-color:#03a9f4;color: white;"><td style="padding: 10px;" class="top-heading" colspan="3"><strong>SALE DEMAND</strong></td></tr>
        ...
        <tr class="">
         ...
         $d_date=date_create($demand['doc_date'] );
           ...
           $from=date_create($demand['from'] );
           $from=date_format($from,"d-M-Y");

           $to=date_create($demand['to'] );
    ...
    <div style="height:30px;background-color: #03a9f4;"></div>
     ...
     <thead style="background-color:#03a9f4;color: white;">
      ...
      <?php   $total=$total+$item['pivot']['qty']; 
       ...
       <tr>
         ...
         <td class="col">{{$uom}}</td>
         <td class="col">{{$item['pack_size']}}</td>
         <td class="col">{{$item['pivot']['qty']}}</td>
